...
import { allAppliedJobs, applyJobApplicationController, withdrawJobApplicationController } from "../controllers/applications.controller.js";
...
//   } catch (error) {
  ...
  router.get("/lists", isLoggedInMiddleware, allAppliedJobs)
