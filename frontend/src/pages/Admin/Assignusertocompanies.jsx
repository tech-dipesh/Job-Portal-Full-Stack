  ...
  return (
    <main className='min-h-screen p-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
        <div className='bg-slate-800 border border-slate-600 rounded-2xl p-6 lg:flex lg:flex-col grid grid-cols-1 gap-4'>
          {/* grid grid-cols-1 gap-4 lg:grid-cols-3 */}
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 lg:flex lg:items-center lg:justify-between'>
